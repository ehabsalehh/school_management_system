    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Fees.index')}}">{{trans('Fees_trans.Study_Fees')}}</a> </li>
                <li> <a href="{{route('Fees_Invoices.index')}}">{{trans('Fees_trans.Inovices')}}</a> </li>
                <li> <a href="{{route('receipt_students.index')}}">{{trans('Fees_trans.Receipt')}}</a> </li>
                <li> <a href="{{route('ProcessingFee.index')}}">{{trans('Fees_trans.Exclude_fee')}}</a> </li>
                <li> <a href="{{route('Payment_students.index')}}">{{trans('Fees_trans.Voucher_exchange')}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Subjects">
                <div class="pull-left"><i class="fas fa-book-open"></i><span class="right-nav-text">{{trans("library_trans.Subject")}} </span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="Subjects" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('subjects.index')}}"> {{trans("library_trans.Subject_menu")}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Exams-icon">
                <div class="pull-left"><i class="fas fa-book-open"></i><span class="right-nav-text">{{trans("Quizz_trans.Quizzes")}}</span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Quizzes.index')}}">{{trans("Quizz_trans.Quizz_menu")}}</a> </li>
                <li> <a href="{{route('questions.index')}}">{{trans("Question_trans.Question_menu")}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('library.index')}}"> {{trans("library_trans.Books_menu")}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('onlineClasses.index')}}">{{trans("library_trans.Online_session_with_zoom")}}</a> </li>
            </ul>
        </li>
