                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('Quizzes.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">{{__("Quizz_trans.Add_new_quizz")}}</a><br><br>
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>{{__("Quizz_trans.Quizz_name")}}</th>
                                            <th>{{__("Quizz_trans.Teacher_name")}}</th>
                                            <th>{{trans('Students_trans.Grade')}}</th>
                                            <th>{{trans('Students_trans.classrooms')}}</th>
                                            <th>{{trans('Students_trans.classrooms')}}</th>
                                            <th>{{__("Question_trans.operation")}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 style="font-family: 'Cairo', sans-serif;"
                                                                    class="modal-title" id="exampleModalLabel">{{__("Question_trans.Delete")}} </h5>
