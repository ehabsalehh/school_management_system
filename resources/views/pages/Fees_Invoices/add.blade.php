...
@section('css')
    @toastr_css
@section('title')
{{__("Fees_trans.Add_a_new_invoice")}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{__("Fees_trans.Add_a_new_invoice")}}{{$student->name}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                        ...
                        <form class=" row mb-30" action="{{ route('Fees_Invoices.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="repeater">
                                    <div data-repeater-list="List_Fees">
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="Name" class="mr-sm-2">{{__("Fees_trans.Student_name")}}</label>
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{__("Fees_trans.Fees_type")}}</label>
                                                    <div class="box">
                                                        <select class="fancyselect" name="fee_id" required>
                                                            <option value="">-- {{__("Fees_trans.Select_From_menu")}} --</option>
                                                            @foreach($fees as $fee)
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{__("Fees_trans.The_amount")}}</label>
                                                    <div class="box">
                                                ...
                                                <div class="col">
                                                    <label for="description" class="mr-sm-2">{{__("Fees_trans.Statement")}}</label>
                                                    <div class="box">
                                    ...
                                    <button type="submit" class="btn btn-primary">{{__("Fees_trans.Confirm_Data")}}</button>
                                </div>
                            </div>
                        </form>
