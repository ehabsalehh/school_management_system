...
@section('css')
    @toastr_css
@section('title')
{{__("Fees_trans.Tuition_fee_edit")}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                    ...
                    <form action="{{route('Fees_Invoices.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4"> {{__("Fees_trans.Student_name")}}</label>
                            ...
                            <div class="form-group col">
                                <label for="inputEmail4">{{__("Fees_trans.The_amount")}}</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="inputZip">{{__("Fees_trans.Fees_type")}}</label>
                        ...
                        <button type="submit" class="btn btn-primary">{{__("Fees_trans.Confirm")}}</button>
