...
@section('css')
    @toastr_css
@section('title')
{{__("Fees_trans.Tuition_bills")}}@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{__("Fees_trans.Tuition_bills")}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr class="alert-success">
                                            <th>#</th>
                                            <th>{{__("main_trans.students")}}</th>
                                            <th>{{__("Fees_trans.Fees_type")}} </th>
                                            <th>{{__("Fees_trans.The_amount")}}</th>
                                            <th>{{__("main_trans.Grades")}}</th>
                                            <th>{{__("main_trans.classes")}}</th>
                                            <th>{{__("Fees_trans.Statement")}}</th>
