...
@section('css')
    @toastr_css
@section('title')
{{__("payment_trans.edit_receipt")}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{__("payment_trans.edit_receipt")}} <label style="color: red">{{$payment_student->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>__{{"Fees_trans.The_amount"}}<span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>__{{"Fees_trans.Statement"}}<span class="text-danger">*</span></label>
