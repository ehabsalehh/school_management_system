...
@section('css')
    @toastr_css
@section('title')
{{trans('Attendance_translate.attendance_and_absence_menu')}}@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{trans('Attendance_translate.attendance_and_absence_menu')}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
    ...
    <h5 style="font-family: 'Cairo', sans-serif;color: red"> {{trans("Attendance_translate.today's_date")}}  : {{ date('Y-m-d') }}</h5>
    <form method="post" action="{{ route('attendance') }}" autocomplete="off">
        ...
        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
            ...
            <tr>
                ...
                <th class="alert-success">{{trans('Attendance_translate.presence_and_absent')}}</th>
            </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>        
                        <label class="block text-gray-500 font-semibold sm:border-r sm:pr-4">
                            ...
                            <span class="text-success">{{trans('Attendance_translate.presence')}}</span>
                        </label>
                        ...
                        <label class="ml-4 block text-gray-500 font-semibold">
                            ...
                            class="leading-tight" type="radio"
                                    value="absent">
                            <span class="text-danger">{{trans('Attendance_translate.absent')}}</span>
                        </label>
