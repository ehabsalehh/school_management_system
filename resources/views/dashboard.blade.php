 ...
 Main content -->
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-0">{{trans('Dashboard_trans.Admin_dashboard')}}</h4>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="float-right text-right">
                                <p class="card-text text-dark">{{trans('Dashboard_trans.Students_number')}}</p>
                ...
                <div class="card card-statistics h-100">
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="float-right text-right">
                                <p class="card-text text-dark">{{trans('Dashboard_trans.Teachers_number')}}</p>
                ...
                <div class="card card-statistics h-100">
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="float-right text-right">
                                <p class="card-text text-dark">{{trans("Dashboard_trans.Parent's_numer")}}</p>
                ...
                <div class="card card-statistics h-100">
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="float-right text-right">
                                <p class="card-text text-dark"> {{trans("Dashboard_trans.Classrooms_number")}}</p>
                        ...
                        <div class="tab nav-border" style="position: relative;">
                            <div class="d-block d-md-flex justify-content-between">
                                <div class="d-block w-100">
                                    <h5 style="font-family: 'Cairo', sans-serif" class="card-title">{{trans('Dashboard_trans.The_last_operations_on_the_system')}}</h5>
                                </div>
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active show" id="students-tab" data-toggle="tab"
                                               ...
                                               aria-selected="true"> {{trans('Dashboard_trans.Students')}}</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" id="teachers-tab" data-toggle="tab" href="#teachers"
                                               role="tab" aria-controls="teachers" aria-selected="false">{{trans('Dashboard_trans.Teachers')}}
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" id="parents-tab" data-toggle="tab" href="#parents"
                                               role="tab" aria-controls="parents" aria-selected="false">{{trans("Dashboard_trans.Parent's")}}
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" id="fee_invoices-tab" data-toggle="tab" href="#fee_invoices"
                                               role="tab" aria-controls="fee_invoices" aria-selected="false">{{trans('Dashboard_trans.Invoices')}}
                                            </a>
                                        </li>
                                    ...
                                    <div class="table-responsive mt-15">
                                        <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                            ...
                                            <tr  class="table-info text-danger">
                                                ...
                                                <th>{{ trans('Dashboard_trans.Added_date')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            @forelse(\App\Models\Student::latest()->take(5)->get() as $student)
                                                <tr>
                                                    ...
                                                    @empty
                                                        <td class="alert-danger" colspan="8">{{trans('Dashboard_trans.No_data')}}</td>
                                                </tr>
                                            @endforelse
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="table-responsive mt-15">
                                        <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                            ...
                                            <tr  class="table-info text-danger">
                                                ...
                                                <th>{{trans('Students_trans.gender') }}</th>
                                                <th>{{trans('Dashboard_trans.date_of_being_hired')}}</th>
                                                <th>{{trans('Dashboard_trans.Specialization')}}</th>
                                                <th> {{trans('Dashboard_trans.Added_date')}}</th>
                                            </tr>
                                            </thead>
                                ...
                                <div class="tab-pane fade" id="parents" role="tabpanel" aria-labelledby="parents-tab">
                                    <div class="table-responsive mt-15">
                                        <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                            ...
                                            <tr  class="table-info text-danger">
                                                <th>#</th>
                                                <th>{{trans('Dashboard_trans.Father_name')}}</th>
                                                <th>{{ trans('Students_trans.email') }}</th>
                                                <th>{{trans('Dashboard_trans.id')}}</th>
                                                <th>{{trans('Dashboard_trans.phone_number')}}</th>
                                                <th> {{trans('Dashboard_trans.Added_date')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                ...
                                <div class="tab-pane fade" id="fee_invoices" role="tabpanel" aria-labelledby="fee_invoices-tab">
                                    <div class="table-responsive mt-15">
                                        <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                            ...
                                            <tr  class="table-info text-danger">
                                                <th>#</th>
                                                <th> {{trans('Dashboard_trans.Date_of_invoice')}}</th>
                                                <th>{{ trans('Students_trans.name') }}</th>
                                                <th>{{ trans('Students_trans.Grade') }}</th>
                                                <th>{{ trans('Students_trans.classrooms') }}</th>
                                                <th>{{ trans('Students_trans.section') }}</th>
                                                <th>{{ trans('Fees_trans.Fees_type')}} </th>
                                                <th>{{ trans('Fees_trans.The_amount')}}</th>
                                                <th> {{trans('Dashboard_trans.Added_date')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            @empty
                                                <tr>
                                                    <td class="alert-danger" colspan="9">{{trans('Dashboard_trans.No_data')}}</td>
                                                </tr>
                                            @endforelse
                                            </tbody>
                                        </table>
