...
class StudentPromotionRepository implements StudentPromotionRepositoryInterface
{
    ...
    public function store($request)
    {
        ...
        try {
            ...
            if ($students->count() < 1) {
                return redirect()->back()->with('error_promotions', __('no data in student table'));
            }
    ...
    public function destroy($request)
    {
        ...
        try {
            ...
            //    delete Promotion table
                ...
                //Rollback Promotion to specific Student
                ...
                // delete prmotion to specific student
