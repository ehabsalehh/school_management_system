...
class AddParent extends Component
{
    ...
    public $catchError;
    public $currentStep = 1,$filename,$imageable_id,$imageable_type,
    ...
    public function submitForm(){
        ...
        try {
            ...
            //         $file->storeAs('attachments/my_parents/'.$My_Parent->Name_Father,$name,"upload_attachments");

            //         // insert in image_table
            //         $images= new Image();
            //         $images->filename=$name;
            //         $images->imageable_id= $this->id;
            ...
            if (!empty($this->photos)){
                foreach ($this->photos as $photo) {
                    ...
                    $photo->storeAs('attachments/my_parents/'.$My_Parent->Name_Father,$name,"upload_attachments");
